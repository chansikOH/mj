    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-10">
                ...
                <form name="form_review" id="form_review" method="post" action="editReview.hta" enctype="multipart/form-data">
                    ...
                    <table class="table">
                        <tbody>
                            <tr>
                                ...
                                <td><input type="text" name="subject" value="${review.title }" size="98px;"></td>
                            </tr>
                            
                            <tr>
                                <th class="background-color">후기작성</th>
                                <td>
                                    <textarea class="" name="content" cols="100" rows="10" style="resize: none">${review.content }</textarea>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <th class="background-color">사진등록</th>
	                                ...
	                                <td>
	                                    <input type="file" name="file" class="file_upload" onchange="photoUp($(this))" value="${review.img }">
